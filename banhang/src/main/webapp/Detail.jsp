                            ...
                            <div class="row">
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        <div class="img-big-wrap">
                                            <div> <a href="#"><img src="thoitrang/body-den.jpg"></a></div>
                                        </div> <!-- slider-product.// -->
                                        <div class="img-small-wrap">
                                            <div class="item-gallery"> <img src="thoitrang/body-den.jpg"> </div>
                                            <div class="item-gallery"> <img src="thoitrang/body-den.jpg"> </div>
                                            <div class="item-gallery"> <img src="thoitrang/body-den.jpg"> </div>
                                            <div class="item-gallery"> <img src="thoitrang/body-den.jpg"> </div>
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        <h3 class="title mb-3">Đầm body đen</h3>

                                        <p class="price-detail-wrap"> 
                                            <span class="price h3 text-warning"> 
                                                <span class="currency">12 $</span><span class="num">${p.price}</span>
                                            </span> 
                                            <!--<span>/per kg</span>--> 
                                        </p> <!-- price-detail-wrap .// -->
